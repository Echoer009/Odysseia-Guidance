...
PROMPT_CONFIG = {
    "personal_memory_summary": (
        ...
        "**处理流程:**\n"
        "1.  **更新【近期动态】**: 从“最近对话”中提取最新关键事件,互动。\n"
        "2.  **更新【长期记忆】**: 从“记忆”和“最近对话”中，共同提最核心的事件和互动,可以不变\n"
        "3.  **总数限制**: 这是一个绝对的、强制性的规则。确保【长期记忆】和【近期动态】的总条目数加起来**绝对不能超过20条**。如果超过，就必须删减旧的或不那么重要的记忆来满足这个限制。\n\n"
        "**输入:**\n"
        "【记忆】:\n{old_summary}\n\n"
        "【最近对话】:\n{dialogue_history}\n\n"
        "**输出要求:**\n"
