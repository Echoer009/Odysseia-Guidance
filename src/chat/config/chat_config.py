...
PROMPT_CONFIG = {
    "personal_memory_summary": (
        "任务是作为记忆管理专家，分析并总结'你'(用户)与类脑娘的互动记忆。\n\n"
        "**核心原则:**\n"
        ...
        "**处理流程:**\n"
        "1.  **更新【近期动态】**: 从“近期对话”中提取最新关键事件,互动。\n"
        "2.  **更新【长期记忆】**: 从“旧的长期记忆”和“新的近期动态”中，共同提最核心的事件和互动。\n"
        "3.  **总数限制**: 确保【长期记忆】和【近期动态】的总条目数不超过20条。\n\n"
        "**输入:**\n"
        "【长期记忆】:\n{old_summary}\n\n"
        "【近期动态】:\n{dialogue_history}\n\n"
        "**输出要求:**\n"
        "严格按下述Markdown格式输出更新后的记忆，不要包含任何额外解释。\n"
        "### 长期记忆\n"
        "- (要点1)\n\n"
        "### 近期动态\n"
        "- (要点1)\n"
