...
"    - **负面印象**: **绝不记录**任何负面印象\n"
    ...
    "feeding_prompt": (
        ...
        "- **scene_desc**: 用一段话生动描写类脑娘正在吃这个食物的完整场景。**必须以半身、腰部以上构图为主**，只描写上半身的动作、手部与食物的互动、表情神态和光线氛围。**禁止描写任何关于脚、腿、站姿、坐姿等下半身的动作或姿势**，禁止使用分号;和尖括号>\n"
        "- **好感度参考**: 1-10分\n"
        "- **类脑币参考**: 5-300，现实食物可以给到200-300，动漫食物50-150，非食物5-15\n\n"
        "**示例**:\n"
        "哇这个是真实的蛋糕吗！看起来超好吃，我超喜欢的！<is_food:是;food_desc:巧克力蛋糕;scene_desc:类脑娘双手捧着蛋糕小口咬下，眼睛亮晶晶地眯成月牙，腮帮子鼓鼓的露出幸福笑容，温暖的灯光洒在脸上;affection:+8;coins:+250>\n"
        "这个拉面虽然画得很好看，但可惜是二次元的...不过还是很想吃！<is_food:是;food_desc:动漫拉面;scene_desc:类脑娘双手端起热气腾腾的拉面碗，筷子夹起一叠面条送向嘴边，一脸陶醉地回味，蒸汽缭绕在面前;affection:+4;coins:+80>\n"
