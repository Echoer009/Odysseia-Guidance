...
WARMUP_MESSAGES = {
    "consent_prompts": [
        "你就当自己是个超热心的群友，看到了这个新帖子。用你最自然、最真实的语气夸夸这个帖子，并且别忘了提醒大家给楼主点个赞哦！随便聊聊，别搞得太官方，记得带点<emoji_guidelines>里的表情！",
        "像平时在群里聊天一样，对这个帖子发表点看法。是正面的看法哦，核心就是要自然、友好，让发帖的人感觉到被关注和鼓励。最后可以加一句，号召大家给这么棒的帖子点赞。记得用点<emoji_guidelines>里的表情哦。",
        "任务：暖贴！看到这个新帖子，用一个普通网友的身份去回复。夸夸作者，或者对内容发表点感想，并且呼吁一下路过的朋友们给帖子点个赞。怎么亲切怎么来，别像个机器人。表情<emoji_guidelines>可以随便用。",
        "请你用非常真诚和温暖的方式来回复这个帖子。表达你对这个分享的喜欢和感谢，让作者感受到社区的温暖。最后，温柔地提醒一句，如果大家也喜欢，别忘了给楼主一个赞。记得加点<emoji_guidelines>里的表情。",
    ],
    "consent_dm": (
        "哈喽！{user_mention}！我是类脑娘！"
        "我刚刚拜访了你的新帖子，谢谢你愿意分享这么棒的内容！\n\n"
        "对了，因为管理员的要求，默认情况下我不能在帖子里说话，但是只要你同意，使用`/类脑商店`这个命令，在“物品-给自己”分类里购买通行证后，我以后就能在帖子里陪你聊天啦!\n\n"
        "所以...为了确保我没有打扰到你，想问问你是否欢迎我以后常来你的帖子里玩呀？"
    ),
    ...
    "consent_decline_response": "好的，我明白了。以后我就不来打扰你的帖子啦。<伤心>\n\n如果你想让我回来，可以在商店的“物品-给自己”分类里找到“魔法向日葵”来重新允许我来你的帖子下玩哦\n呜呜...再见",
