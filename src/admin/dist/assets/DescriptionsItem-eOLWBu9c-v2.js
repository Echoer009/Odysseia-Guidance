import{I as h,l as e,P as H,m as P,H as L,aM as q,aN as J,d as N,n as F,aj as K,a as i,c as a,r as s,p as u,q as n,J as _,y as W,D as Q,E as M,aO as U,aP as X,ap as j}from"./index-BwbiZBuu-v2.js";import{u as Y,g as Z}from"./Space-UXzqZFPv-v2.js";function V(t,m="default",c=[]){const{children:d}=t;if(d!==null&&typeof d=="object"&&!Array.isArray(d)){const l=d[m];if(typeof l=="function")return l()}return c}var ee=h([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
